#encoding:utf-8
from principal.models import Usuario, Puntuacion, Pelicula
from principal.forms import  UsuarioBusquedaForm
from recomendacion.forms import PeliculaBusquedaForm
from django.shortcuts import render, get_object_or_404
from django.http.response import HttpResponseRedirect
from django.conf import settings
from recomendacion.recommendations import  transformPrefs, calculateSimilarItems, getRecommendations, getRecommendedItems, topMatches
import shelve
...
def loadDict():
    ...
    for ra in ratings:
        user = int(ra.usuario.id_usuario)
        itemid = int(ra.pelicula.id_pelicula)
